...
CREATE TABLE support_tickets (
  ...
  created_source text NOT NULL CHECK (created_source IN ('CUSTOMER','STAFF','AUTO_OVERDUE')),
...
CREATE TABLE support_ticket_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  ticket_id uuid NOT NULL REFERENCES support_tickets(id) ON DELETE CASCADE,
  event_type text NOT NULL CHECK (event_type IN ('STATUS_CHANGE','PRIORITY_CHANGE','RESOLUTION_SET','REOPENED','NOTE_ADDED')),
  from_value text,
  to_value text,

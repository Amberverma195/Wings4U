...
const STEPS: Step[] = [
  {
    ...
    desc: "Browse 74+ hand-crafted flavors. Choose your sauce. Sauced or plain. Customize like you mean it.",
    arrow: true,
  },
  {
    num: "02",
  ...
  },
  {
    ...
    desc: "Walk in and grab it hot, or we'll bring it to your door. Pickup in 15-25 minutes. Delivery available.",
    arrow: false,
  },
];
